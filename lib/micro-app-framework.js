...
const PAGE_SIZE_NAME = 'page_size.json';
...
var getPage = function(pageName, app, dir, request, replacements) {
  ...
  if (pageName === PAGE_OPEN_NAME) {
    ...
    page = page.replace('<SCROLL_BARS>', scrollBars);
  }
...
var onConnect = function(request, response, app, dir) {
  ...
  if (!pageHandled) { 
    ...
    if ((requestUrl.query !== null) && (requestUrl.query.size !== undefined)) {
      var windowSizePage = getPage(PAGE_SIZE_NAME, app, __dirname, request, replacements);
      response.writeHead(200, {'Content-Type': 'application/json'});
      response.end(windowSizePage);
    } else if ((app.config.useLaunchWindow === "true") || ((requestUrl.query !== null) && (requestUrl.query.windowopen !== undefined))) {
